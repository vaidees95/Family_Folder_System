 ...
 */
public class Report_location2 extends AppCompatActivity {
    Spinner sp;
    Spinner sp1;
    Button bn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.report_location2);
        ...
        protected void onPostExecute(String file_url) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(Report_location2.this, android.R.layout.simple_spinner_item,taluk);
