...
public class spin2 extends AppCompatActivity {
    ...
    Spinner sp1;
    Button bn;
    private static String url = "http://192.168.43.234//yet//spinner1.php";
        ...
        protected void onPostExecute(String file_url) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(spin2.this, android.R.layout.simple_spinner_item,taluk);
