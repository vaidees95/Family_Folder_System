...
public class Chart_location extends AppCompatActivity {
    Spinner sp;
    Spinner sp1;
    Button bn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chartlocation);
                ...
                public void run() {
                 ...
                 //   taluk1 = new HashSet<String>(taluk);
                   ...
                   // Collections.sort(taluk);
                    ...
                    ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(Chart_location.this, android.R.layout.simple_spinner_item,dist);
                    adapter1.setDropDownViewResource(R.layout.support_simple_spinner_dropdown_item);
                    sp.setAdapter(adapter1);
                  //  ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(Chart_location.this, android.R.layout.simple_spinner_item,taluk);
