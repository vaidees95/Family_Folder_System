 ...
 */
public class Chart_location1 extends AppCompatActivity {
    Spinner sp;
    Spinner sp1;
    Button bn;
    private static String url = "http://ffs.kongu.edu/report/spinner.php";
    private static String url1 = "http://ffs.kongu.edu/healthcare/join1.php";
    private static String url2 = "http://ffs.kongu.edu/healthcare/join.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chart_location1);
        ...
        bn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(),Chart_location2.class);
        ...
        protected void onPostExecute(String file_url) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(Chart_location1.this, android.R.layout.simple_spinner_item,dist);
