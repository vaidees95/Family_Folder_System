 ...
 */
public class spin1 extends AppCompatActivity {
    Spinner sp;
    Spinner sp1;
    Button bn;
    private static String url = "http://192.168.43.234//yet//spinner.php";
        ...
        bn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               // String spinner1= sp.getSelectedItem().toString();
                ...
                Intent intent = new Intent(getApplicationContext(),spin2.class);
                ...
                public void run() {
                 ...
                 //   taluk1 = new HashSet<String>(taluk);
                   // taluk.clear();
                    ...
                    ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(spin1.this, android.R.layout.simple_spinner_item,dist);
