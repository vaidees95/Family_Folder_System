...
public class Occupation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.occupation);
        ...
        int selfemployed = extras.getInt("selfemployed");


        //  Toast.makeText(this,num+"",Toast.LENGTH_LONG).show();

        int y[] = {child,student,employed,selfemployed,unemployed};
        CategorySeries series = new CategorySeries("Occupation");
        ...
        mRenderer.setChartTitle("OCCUPATION REPORT");
...
//
        ...
        mRenderer.setAxisTitleTextSize(20);
        mRenderer.addXTextLabel(1, "Child");
        mRenderer.addXTextLabel(2, "Student");
        mRenderer.addXTextLabel(3, "Employed");
        mRenderer.addXTextLabel(4, "Selfemployed");
        mRenderer.addXTextLabel(5, "Unemployed");
